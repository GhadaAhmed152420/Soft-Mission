...
import 'package:eschool/ui/screens/subjectDetails/widgets/lessonVideosContainer.dart';
...
import '../../../cubits/subjectVideosCubit.dart';
    ...
    return CupertinoPageRoute(
      builder: (_) => MultiBlocProvider(
        providers: [
          ...
          BlocProvider<SubjectVideosCubit>(
            create: (_) => SubjectVideosCubit(SubjectRepository()),
          ),
        ],
          ...
          return Stack(
            children: [
              ...
              AnimatedAlign(
                ...
                child: TabBarBackgroundContainer2(
                  boxConstraints: boxConstraints,
                  titleKey: _selectedTabTitle,
                ),
              ),
              CustomTabBarContainer2(
                boxConstraints: boxConstraints,
