...
import '../weekly_report/weekly_report_container.dart';
  ...
  Widget _buildMenuItemContainer() {
    if (homeBottomSheetMenu[_currentlyOpenMenuIndex].title == attendanceKey) {
      ...
      return const ReportSubjectsContainer();
        ...
        weeklyReportsKey) {
      return WeeklyReportSubjectsContainer();
    } else {
                  ...
                  IndexedStack(
                    ...
                    children: [
                      ...
                      _currentlyOpenMenuIndex != -1
                          ...
                          : _previousSelectedBottomNavIndex == 0
                              ? const HomeContainer(
                                  isForBottomMenuBackground: true,
                                )
                              : _previousSelectedBottomNavIndex == 1
                                  ? const ChatUsersScreen(
                                      isForBottomMenuBackground: true,
                                    )
                                  : _previousSelectedBottomNavIndex == 2
                                      ? const AssignmentsContainer(
                                          isForBottomMenuBackground: true,
                                        )
                                      : const SizedBox(),
