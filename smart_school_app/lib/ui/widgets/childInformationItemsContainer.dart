  ...
  Widget build(BuildContext context) {
    _menuItems = [
      ...
      MenuContainerDetails(
        ...
        arguments: {
          "event": {'hasBack': true, "isEvent": false},
        },
      ...
      MenuContainerDetails(
        route: Routes.weeklyReports,
        arguments: {
          "childId": widget.student.id,
          "subjects": widget.subjectsForFilter
        },
        iconPath: UiUtils.getImagePath("reports_icon.svg"),
        title: UiUtils.getTranslatedLabel(context, weeklyReportsKey),
      ),
      MenuContainerDetails(
        ...
        iconPath: UiUtils.getImagePath("teachers_icon.svg"),
        title: UiUtils.getTranslatedLabel(context, evaluationTeacherKey),
      ),
    ];
