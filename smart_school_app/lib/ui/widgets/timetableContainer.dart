...
class _TimeTableContainerState extends State<TimeTableContainer>
  ...
  Widget _buildDayContainer(int index) {
    List<String> weekDays = [
      UiUtils.getTranslatedLabel(context, sundayKey),
      UiUtils.getTranslatedLabel(context, mondayKey),
      UiUtils.getTranslatedLabel(context, tuesdayKey),
      UiUtils.getTranslatedLabel(context, wednesdayKey),
      UiUtils.getTranslatedLabel(context, thursdayKey),
      UiUtils.getTranslatedLabel(context, fridayKey),
      UiUtils.getTranslatedLabel(context, saturdayKey),
    ];
    return InkWell(
      onTap: () {
        setState(() {
