...
class Api {
  ...
  static String weeksParentUrl = "${databaseUrl}parent/get-evaluations-weeks";
  static String weeksStudentUrl = "${databaseUrl}student/get-evaluations-weeks";
  static String weeklyParentReportsUrl =
      "${databaseUrl}parent/get-evaluations-report";
  static String teachersParentUrl = "${databaseUrl}parent/childTeachers";
  static String teachersEvaluationsParentUrl =
      "${databaseUrl}parent/storeEvaluation";
  static String weeklyStudentReportsUrl =
      "${databaseUrl}student/get-evaluations-report";
  ...
  static String getStudentVideosOfSubject =
      "${databaseUrl}student/lessons-video-list";
  static String getParentVideosOfSubject =
      "${databaseUrl}parent/lessons-video-list";
