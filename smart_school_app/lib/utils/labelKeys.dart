...
const String weeklyReportsKey = "weeklyReports";

const String explanationKey = "explanation";
const String followingOnAssignmentsKey = "followingOnAssignments";
const String commitmentClassTimeKey = "commitmentClassTime";
const String takingIndividualDifferencesKey = "takingIndividualDifferences";
const String methodDealingInteractingStudentsKey =
    "methodDealingInteractingStudents";
const String veryBadKey = "veryBad";
const String badKey = "bad";
const String goodKey = "good";
const String veryGoodKey = "veryGood";
const String excellentKey = "excellent";

const String evaluationTeacherKey = "evaluationTeacher";
...
const String homeworkKey = "homework";
const String studentLevelKey = "studentLevel";
...
const String noWeeklyReportsKey = "noWeeklyReports";
...
const String noUsersKey = "noTeachers";
