...
import '../ui/screens/teachers_evaluation/cubits/teachers_evaluation_cubit.dart';
import '../ui/screens/weekly_report/cubits/weekly_cubit.dart';
import '../ui/screens/weekly_report/repositories/weekly_report_repo.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider<TeachersEvaluationCubit>(
          create: (context) =>
              TeachersEvaluationCubit(TeachersEvaluationRepo()),
        ),
      ],
      child: Builder(
        builder: (context) {
